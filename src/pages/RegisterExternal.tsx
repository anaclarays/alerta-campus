...
const RegisterExternal: React.FC = () => {
  ...
  const handleSubmit = async () => {
    const requiredFields = ['username', 'name', 'birthDate', 'gender', 'address', 'cpf', 'phone', 'email'];
    ...
    <div className="mobile-container flex flex-col min-h-screen bg-background">
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border p-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">Cadastro Externo</h1>
        </div>
      </div>
